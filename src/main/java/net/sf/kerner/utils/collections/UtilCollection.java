...
public class UtilCollection {
    ...
    public static <C> Collection<C> filterCollection(final Collection<? extends C> collection,
            final Filter<C> filter, final boolean isSorted) {
        boolean found = false;
    ...
    public static <T> Collection<Collection<T>> getSame(final Collection<? extends T> c,
            final Equalator<T> equalator) {
    ...
    public static <T> String toString(final Iterable<T> iterable,
            final Transformer<T, String> transformer, final String objectSeparator) {
